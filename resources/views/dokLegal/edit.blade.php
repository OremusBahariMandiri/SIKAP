            ...
            <div class="col-md-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dokLegal.update', $dokLegal) }}" method="POST"
                            enctype="multipart/form-data" id="dokLegalForm">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="card-body">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('NoRegDok', $dokLegal->NoRegDok) }}"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select @error('perusahaan_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($perusahaans as $id => $nama)
                                                        <option value="{{ $id }}"
                                                            {{ old('perusahaan_id', $dokLegal->perusahaan_id) == $id ? 'selected' : '' }}>
                                                            {{ $nama }}</option>
                                                    @endforeach
                                                </select>
                                                @error('perusahaan_id')
                                                ...
                                                <input type="hidden" id="DokPerusahaan" name="DokPerusahaan"
                                                    value="{{ old('DokPerusahaan', $dokLegal->DokPerusahaan) }}">
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select @error('kategori_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($kategoris as $id => $kategori)
                                                        <option value="{{ $id }}"
                                                            {{ old('kategori_id', $dokLegal->kategori_id) == $id ? 'selected' : '' }}>
                                                            {{ $kategori }}</option>
                                                    @endforeach
                                                </select>
                                                @error('kategori_id')
                                                ...
                                                <input type="hidden" id="KategoriDok" name="KategoriDok"
                                                    value="{{ old('KategoriDok', $dokLegal->KategoriDok) }}">
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select @error('jenis_id') is-invalid @enderror"
                                                    ...
                                                    data-old-value="{{ old('jenis_id', $dokLegal->jenis_id) }}">
                                                    <option value="">-- Pilih Jenis --</option>
                                                    @foreach ($formattedJenisDoks as $id => $jenis)
                                                        <option value="{{ $id }}"
                                                            data-kategori-id="{{ $jenis['kategori_id'] }}"
                                                            {{ old('jenis_id', $dokLegal->jenis_id) == $id ? 'selected' : '' }}>
                                                            {{ $jenis['name'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <input type="hidden" id="JenisDok" name="JenisDok"
                                                    value="{{ old('JenisDok', $dokLegal->JenisDok) }}">
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('PeruntukanDok', $dokLegal->PeruntukanDok) }}"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="DokAtasNama" name="DokAtasNama"
                                                    value="{{ old('DokAtasNama', $dokLegal->DokAtasNama) }}"
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="bg-light p-2 rounded">
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                            ...
                                                            value="Tetap"
                                                            {{ old('JnsMasaBerlaku', $dokLegal->JnsMasaBerlaku) == 'Tetap' ? 'checked' : '' }}
                                                            required>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input
                                                            ...
                                                            value="Perpanjangan"
                                                            {{ old('JnsMasaBerlaku', $dokLegal->JnsMasaBerlaku) == 'Perpanjangan' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date"
                                                                ...
                                                                value="{{ old('TglTerbitDok', $dokLegal->TglTerbitDok ? $dokLegal->TglTerbitDok->format('Y-m-d') : '') }}"
                                                                required>
                                                            @error('TglTerbitDok')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                    ...
                                                    <div class="form-group mb-3 tgl-berakhir-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date"
                                                                ...
                                                                value="{{ old('TglBerakhirDok', $dokLegal->TglBerakhirDok ? $dokLegal->TglBerakhirDok->format('Y-m-d') : '') }}">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control bg-light" id="MasaBerlaku"
                                                    name="MasaBerlaku"
                                                    value="{{ old('MasaBerlaku', $dokLegal->MasaBerlaku) }}" readonly>
                                            ...
                                            <div class="form-group mb-3 tgl-pengingat-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date"
                                                        ...
                                                        value="{{ old('TglPengingat', $dokLegal->TglPengingat ? $dokLegal->TglPengingat->format('Y-m-d') : '') }}">
                                                    @error('TglPengingat')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control bg-light" id="MasaPengingat"
                                                    name="MasaPengingat"
                                                    value="{{ old('MasaPengingat', $dokLegal->MasaPengingat) }}" readonly>
                                                <div class="form-text text-muted"><i
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        @if ($dokLegal->FileDok)
                                                            <div class="mt-2 d-flex align-items-center">
                                                                ...
                                                                <a href="{{ route('dokLegal.view', $dokLegal) }}"
                                                        ...
                                                        <div class="bg-light p-2 rounded">
                                                            <div class="form-check form-check-inline">
                                                                <input
                                                                    ...
                                                                    value="Berlaku"
                                                                    {{ old('StsBerlakuDok', $dokLegal->StsBerlakuDok) == 'Berlaku' ? 'checked' : '' }}
                                                                    required>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input
                                                                    ...
                                                                    {{ old('StsBerlakuDok', $dokLegal->StsBerlakuDok) == 'Tidak Berlaku' ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3 h-100">
                                                        ...
                                                        <textarea class="form-control @error('KetDok') is-invalid @enderror" id="KetDok" name="KetDok" rows="5"
                                                            placeholder="Masukkan keterangan tambahan jika ada">{{ old('KetDok', $dokLegal->KetDok) }}</textarea>
                                                        @error('KetDok')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Current selected jenis_id to preserve during filtering
            const currentJenisId = document.getElementById('jenis_id').value;
            ...
            function filterJenisDokumen() {
                ...
                // Restore the previously selected value if it belongs to this kategori
                if (currentJenisId) {
                    // Find if the current jenis belongs to the selected kategori
                    const currentJenisOption = allJenisDokOptions.find(opt =>
                        opt.value === currentJenisId &&
                        opt.getAttribute('data-kategori-id') === kategoriId
                    );

                    if (currentJenisOption) {
                        jenisDokSelect.value = currentJenisId;
                        // Update the hidden field
                        document.getElementById('JenisDok').value = currentJenisOption.text;
                    } else {
                        // If current jenis doesn't belong to the new kategori, clear it
