        ...
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <span class="fw-bold"><i class="fas fa-folder me-2"></i>Detail Jenis Dokumen</span>
                    <div>
                        <a href="{{ route('jenis-dok.edit', $jenisDok->id) }}" class="btn btn-warning btn-sm me-2">
                                    ...
                                    <div class="info-group mb-3">
                                        ...
                                        <div class="info-value">
                                            <div class="input-group">
                                                ...
                                                <div class="form-control">{{ $jenisDok->JenisDok }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-group mb-3">
                                        ...
                                        <div class="info-value">
                                            <div class="input-group">
                                                ...
                                                <div class="form-control">{{ $jenisDok->created_at->format('d/m/Y H:i') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-group mb-3">
                                        ...
                                        <div class="info-value">
                                            <div class="input-group">
                                                ...
                                                <div class="form-control">{{ $jenisDok->updated_at->format('d/m/Y H:i') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card border-info">
                                <div class="card-header bg-info bg-opacity-25 text-dark">
                                    <h5 class="mb-0"><i class="fas fa-file-contract me-2"></i>Dokumen Legal dengan Jenis Ini</h5>
                                </div>
                                <div class="card-body">
                                    @if($jenisDok->dokumenLegal()->count() > 0)
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    @foreach($jenisDok->dokumenLegal as $index => $dokumen)
                                                        <tr>
                                    ...
                                    @else
                                        <div class="alert alert-info d-flex align-items-center">
                                            ...
                                            <span>Tidak ada dokumen legal dengan jenis ini.</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
