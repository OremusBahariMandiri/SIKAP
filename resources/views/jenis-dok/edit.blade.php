                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('jenis-dok.update', $jenisDok->id) }}" method="POST">
                            ...
                            <input type="text" class="form-control" id="IdKode" name="IdKode"
                                value="{{ old('IdKode', $jenisDok->IdKode) }}" hidden readonly>
                                    ...
                                    <div class="card border-info">
                                        ...
                                        <div class="card-body">
                                            <div class="info-group mb-3">
                                                <label for="idKategoriDok" class="info-label fw-bold">Kategori
                                                    Dokumen</label>
                                                        ...
                                                        <select class="form-select" id="idKategoriDok" name="idKategoriDok"
                                                            ...
                                                            @foreach ($kategoriDokumen as $kategori)
                                                                <option value="{{ $kategori->id }}"
                                                                    {{ old('idKategoriDok', $jenisDok->idKategoriDok) == $kategori->id ? 'selected' : '' }}>
                                                ...
                                                <div class="info-value">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="JenisDok"
                                                            name="JenisDok"
                                                            value="{{ old('JenisDok', $jenisDok->JenisDok) }}" required>
                                                    </div>
